				...
				<div class="container">
					<div class="row pt-xl">
						<div class="col-md-7">
							...
							<h1 class="mt-xl mb-none">Kapital qanunu</h1>
							<div class="divider divider-primary divider-small mb-xl">
								<hr>
								
istehlakçıların hüquqlarının qorunmasını, investisiya şirkətlərinin qanun çərçivəsində fəaliyyət göstərməsini, maliyyə bazarının sabitliyinin təmin edilməsini və.
							</div>
						</div>
